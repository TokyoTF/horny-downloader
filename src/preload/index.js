...
const updater = {
  ...
  checkForUpdates: isDev ? () => {} : () => ipcRenderer.invoke('check-for-updates'),
  onUpdateDownloaded: (callback) => ipcRenderer.on('update-downloaded', callback),
  removeUpdateDownloadedListener: (callback) =>
    ipcRenderer.removeListener('update-downloaded', callback),
  downloadUpdate: isDev ? () => {} : () => ipcRenderer.invoke('download-update'),
  restartAndUpdate: isDev ? () => {} : () => ipcRenderer.invoke('restart-and-update')
}
const api = {
  updater: {
    ...updater
