...
export default class ExtensionRegistry {
  ...
  async detectExtensionFiles() {
    const extensionsDir = path.join(documentsPath, 'horny-downloader', 'extensions')
  ...
  async initializeExtensions() {
    ...
    for (const extensionName of detectedExtensions) {
      try {
        const extensionPath = path.join(documentsPath, 'horny-downloader', 'extensions', `${extensionName}.js`)
  ...
  async checkForUpdates() {
    ...
    for (const name of extensionsToCheck) {
      try {
        const url = `https://raw.githubusercontent.com/TokyoTF/horny-downloader/main/extensions/${name}Extension.js`
  ...
  async updateExtension(name) {
      try {
        ...
        const filePath = path.join(documentsPath, 'horny-downloader', 'extensions', `${name}Extension.js`)
